...
import challenge.ConversionDistancia;
import challenge.Conversor;
import challenge.Medida;
...
public class distancia extends JFrame {
	...
	public distancia() {
		...
		cmb_ingreso.setModel(new DefaultComboBoxModel(new String[] {"años luz", "kilometros", "metros", "centimetros", "milimetros", "nanometro", "millas", "yardas", "pies", "pulgadas", "millas nautica"}));
		...
		cmb_salida.setModel(new DefaultComboBoxModel(new String[] {"años luz", "kilometros", "metros", "centimetros", "milimetros", "nanometro", "millas", "yardas", "pies", "pulgadas", "millas nautica"}));
