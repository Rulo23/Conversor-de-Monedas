...
public class Conversor extends JFrame {
	...
	public Conversor() {
		...
		cmb_seleccionConversor.setFont(new Font("Arial", Font.BOLD, 18));
		cmb_seleccionConversor.setModel(new DefaultComboBoxModel(new String[] {"Moneda", "Distancia"}));
		panel.add(cmb_seleccionConversor);
		
		JLabel lblIndicativo1 = new JLabel("Elija opcion");
		lblIndicativo1.setBounds(33, 115, 85, 14);
		lblIndicativo1.setForeground(new Color(200, 200, 200));
		panel.add(lblIndicativo1);
		
		JButton btnMenuseleccion = new JButton("Selecciona");
